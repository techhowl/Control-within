...
export default function VideoModal({ open, title, lang = "en", onClose }) {
  ...
  return (
    ...
    >
      <div
        className="relative w-full max-w-3xl overflow-hidden rounded-3xl bg-surface shadow-hover"
      ...
      >
        <button
          ...
          className="absolute right-4 top-4 z-10 flex h-9 w-9 items-center justify-center rounded-full bg-dark/40 text-white transition-colors hover:bg-dark/70"
        >
          ✕
        </button>
