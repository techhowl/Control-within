    ...
    <section id="implant-process" className="bg-surface py-10 md:py-20">
      <div className="mx-auto w-full px-[5%]">
        ...
        <div className="mt-10 flex flex-col items-center gap-4 text-center">
          ...
          <WhatsAppButton message="Hi, I want to know more about Implant" className="inline-flex items-center gap-2 rounded-full bg-teal px-6 py-3 text-xs font-semibold uppercase tracking-wide text-white transition-colors hover:bg-teal-hover">
